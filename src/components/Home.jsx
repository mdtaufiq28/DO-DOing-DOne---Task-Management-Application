            ...
            <div className='flex flex-col gap-x-20 w-11/12 mx-auto marker: pb-10'>
                <section className='flex justify-between items-center'>
                    <button onClick={()=>{
                        ...
                        <img src='/src/assets/icons/filter-icon.svg' className='w-20'></img>
                    </button>
                    ...
                    <div className='flex items-center gap-x-6'>
                        <button className='w-11 hover:bg-gray-200 p-2 rounded-full duration-1000' onClick={()=>{
                            ...
                            <img src='/src/assets/icons/add-item-icon.svg' className='w-20'></img>
                        </button>

                        <button onClick={changeTheme} className='w-10 hover:bg-gray-200 duration-1000 rounded-full p-2'>
                            <img className='duration-1000' src={`/src/assets/icons/${theme==='light' ? 'dark-mode-icon.svg'  : 'day-mode-icon.svg'}`}></img>
                        </button>
                    </div>
